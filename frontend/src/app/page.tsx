            ...
            <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
               ...
               <div className="text-center">
                  ...
                  <p className="mt-6 text-lg leading-8 text-slate-600 max-w-2xl mx-auto">
                     Streamline your professional services with intelligent
                     automation. Manage projects, optimize resources, and
               ...
               <div className="mt-24">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                     <Card>
                        ...
                        <CardContent>
                           <p className="text-sm text-slate-600">
                              Automated project planning, resource allocation,
                              and milestone tracking to keep your projects on
                              time and on budget.
                           </p>
                        </CardContent>
                     </Card>
                     ...
                     <Card>
                        ...
                        <CardContent>
                           <p className="text-sm text-slate-600">
                              Intelligent resource matching based on skills,
                              availability, and project requirements to optimize
                     ...
                     <Card>
                        ...
                        <CardContent>
                           <p className="text-sm text-slate-600">
                              Real-time analytics and reporting to measure
                              project success and identify opportunities for
                              improvement.
                           </p>
                        </CardContent>
                     </Card>
