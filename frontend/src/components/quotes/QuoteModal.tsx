...
export function QuoteModal({ mode, quote, projects, staffers, clientContacts, onClose, onSuccess }: QuoteModalProps) {
  ...
  // For create mode, show as a button that opens modal
  if (mode === 'create') {
    return (
      <>
  ...
  // Edit mode - render as modal directly
  return (
